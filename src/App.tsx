            ...
            <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md m-4 grid gap-4">
                ...
                >
                    <div className="grid gap-1">
                        ...
                        <input
                            type="search"
                            className="p-2 border border-gray-300 rounded-md shadow-sm hover:bg-gray-100 transition-bg duration-200 focus:outline-none focus:border-blue-500 sm:text-sm cursor-pointer text-sm"
                            id="searchFilter"
                            value={searchFilter}
